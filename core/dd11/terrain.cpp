...
ew::MeshData dd11::generateBoulder(float radius, int numSegments, float roughness)
{
    ew::MeshData boulder;
    ew::Vertex v;
    ...
    for (int row = 0; row <= numSegments; row++)
    {
        ...
        for (int col = 0; col <= numSegments; col++)
        {
            ...
            boulder.vertices.push_back(v);
        }
    }

    for (size_t i = 0; i < boulder.vertices.size(); ++i)
    {
        float randomX = (float)(rand()) / 10 * roughness - roughness * 0.5f;
        float randomY = (float)(rand()) / 10 * roughness - roughness * 0.5f;
        float randomZ = (float)(rand()) / 10 * roughness - roughness * 0.5f;

        boulder.vertices[i].pos.x += randomX;
        boulder.vertices[i].pos.y += randomY;
        boulder.vertices[i].pos.z += randomZ;
    }
    ...
    {
        boulder.indices.push_back(poleStart + i);
        boulder.indices.push_back(sideStart + i);
        boulder.indices.push_back(sideStart + i + 1);
    }
    ...
    {
        boulder.indices.push_back(sideStart + i);
        boulder.indices.push_back(poleStart + i + 1);
        boulder.indices.push_back(sideStart + i + 1);
    }
    ...
    for (int row = 0; row < numSegments; row++)
    {
        for (int col = 0; col < numSegments; col++)
        {
            ...
            //Triangle 1
            boulder.indices.push_back(start);
            boulder.indices.push_back(start + columns);
            boulder.indices.push_back(start + 1);
            //Triangle 2
            boulder.indices.push_back(start + 1);
            boulder.indices.push_back(start + columns);
            boulder.indices.push_back(start + columns + 1);
        }
    }
